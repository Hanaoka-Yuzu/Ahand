...
Page({
    ...
    onLoad: function (options) {
      ...
      var oid=wx.getStorageSync('openid')
        wx.request({
            url: serverUrl+'/demand/getAllRelease',
            data: {
                currentPage: 1,
                pageSize:3,
                openid:oid
            ...
            success: function (res) {
              ...
              if(res.data.data.length>=1){
                ...
                that.setData({
                  'dataList[0].endDate':res.data.data[0].state,
              ...
              if(res.data.data.length>=2){
                ...
                that.setData({
                  'dataList[1].endDate':res.data.data[1].state,
              ...
              if(res.data.data.length>=3){
                ...
                that.setData({
                  'dataList[2].endDate':res.data.data[2].state,
